...
public class AccountantController {
    ...
    public ResponseEntity getBranchAccountant(@AuthenticationPrincipal TaxPayer taxPayer,@PathVariable Integer branchId){
    ...
    public ResponseEntity getBusinessAccountant(@AuthenticationPrincipal TaxPayer taxPayer, @PathVariable Integer businessId){
    ...
    public ResponseEntity update(@AuthenticationPrincipal User accountant, @RequestBody @Valid AccountantDTO accountantDTO) {
    ...
    public ResponseEntity deleteAccountant(@AuthenticationPrincipal Accountant accountant) {
    ...
    public ResponseEntity assignAccountantToBranch(@AuthenticationPrincipal User TaxPayer, @PathVariable Integer accountantId, @PathVariable Integer branchId){
    ...
    public ResponseEntity restockProduct(@AuthenticationPrincipal User accountant ,@PathVariable Integer productId,@PathVariable Integer amount){
